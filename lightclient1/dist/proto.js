...
(function (global, factory) {
    ...
    /* CommonJS */else if (typeof require === 'function' && (typeof module === 'undefined' ? 'undefined' : (0, _typeof3.default)(module)) === 'object' && module && module.exports) module.exports = factory(require("protobufjs/minimal"));
    ...
    $root.Model = function () {
        ...
        Model.encode = function encode(message, writer) {
            ...
            if (message.version != null && Object.hasOwnProperty.call(message, "version")) writer.uint32( /* id 1, wireType 0 =*/8).uint32(message.version);
        ...
        Model.verify = function verify(message) {
            ...
            if (message.weights != null && message.hasOwnProperty("weights")) {
                ...
                for (var i = 0; i < message.weights.length; ++i) {
                    if (typeof message.weights[i] !== "number") return "weights: number[] expected";
                }
            }
            return null;
        };
        ...
        Model.fromObject = function fromObject(object) {
            ...
            if (object.weights) {
                if (!Array.isArray(object.weights)) throw TypeError(".Model.weights: array expected");
                message.weights = [];
    ...
    $root.TxShareUpdates = function () {
        ...
        TxShareUpdates.encode = function encode(message, writer) {
            ...
            if (message.seed != null && Object.hasOwnProperty.call(message, "seed")) writer.uint32( /* id 2, wireType 0 =*/16).uint64(message.seed);
            return writer;
        };
        ...
        TxShareUpdates.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                    case 1:
                        if (!(message.gradients && message.gradients.length)) message.gradients = [];
                        if ((tag & 7) === 2) {
                            var end2 = reader.uint32() + reader.pos;
                            while (reader.pos < end2) {
        ...
        TxShareUpdates.verify = function verify(message) {
            ...
            if (message.gradients != null && message.hasOwnProperty("gradients")) {
                if (!Array.isArray(message.gradients)) return "gradients: array expected";
                for (var i = 0; i < message.gradients.length; ++i) {
                    if (typeof message.gradients[i] !== "number") return "gradients: number[] expected";
                }
            }
